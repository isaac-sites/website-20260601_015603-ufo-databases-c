...
show_ads: true
description: AARO's Active Archive often means the record is too thin to resolve, not that a case shows confirmed extraordinary performance.
hero_summary: AARO's Active Archive often means the record is too thin to resolve, not that a case shows confirmed extraordinary performance.
layout: default
...
page_heading_title: What AARO's Active Archive Really Means
source_count: 46
infographic_count: 3
planned_sections:
- What the Active Archive category includes
- Why missing data blocks confident identification
...
next_link:
  ...
  heading_title: Why AARO's Numbers Suddenly Grew
header:
  og_image: /assets/images/ufo_report_databases_8352a3_aaro_unresolved_case_7f814d_active_archive_limit_ebb941-Illustration-1-social.jpg
  preview_image: /assets/images/ufo_report_databases_8352a3_aaro_unresolved_case_7f814d_active_archive_limit_ebb941-Illustration-1.webp
image: /assets/images/ufo_report_databases_8352a3_aaro_unresolved_case_7f814d_active_archive_limit_ebb941-Illustration-1-social.jpg
---
...
* Full sensor recordings rather than short clips.
* Radar tracks.
* Flight telemetry.
* Precise location and timing data.
* Weather information.
* Corroborating witness reports.
* Technical details about the recording system itself.
...
The public often encounters UFO cases through short videos, screenshots or witness descriptions. Investigators face a different problem: they must determine not only what appears on screen but also how the recording was produced.

### Sensor limitations can create uncertainty
...
* The complete recording before and after the event.
* Sensor settings.
* Aircraft motion data.
* Information about zoom levels and tracking modes.
* Environmental conditions.
* Independent sensor confirmation.

</div>

Without that context, ordinary objects can appear unusual. Motion effects, apparent acceleration and shape changes may result from camera movement, perspective, tracking systems or image-processing behaviour rather than the object itself.

When those supporting records are unavailable, analysts may be unable to confirm either a conventional explanation or an extraordinary one. The result is often an unresolved archive entry rather than a finding of anomalous technology.

### Witness testimony alone has limits

Pilot and observer reports are valuable because they alert investigators to unusual events. However, human observation by itself rarely provides enough precision to calculate speed, distance, altitude or manoeuvring performance.
...
CategoryMain reason for statusResolved caseEvidence supports a conventional explanation.Active Archive caseEvidence is too incomplete for a reliable conclusion.Further-analysis caseReported characteristics appear unusual enough to justify additional investigation.
...
* New sensor data are recovered.
* Additional witnesses come forward.
* Similar incidents provide comparison points.
* Technical understanding of a sensor improves.
* Previously separate reports are linked together.

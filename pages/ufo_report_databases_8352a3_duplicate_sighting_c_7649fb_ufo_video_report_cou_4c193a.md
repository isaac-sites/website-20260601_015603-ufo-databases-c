...
show_ads: true
description: A repository entry may be one clip, one report packet or one angle on a broader incident, so video counts need careful interpretation.
hero_summary: A repository entry may be one clip, one report packet or one angle on a broader incident, so video counts need careful interpretation.
layout: default
...
page_heading_title: Why One UFO Clip Is Not Always One Event
source_count: 33
infographic_count: 3
planned_sections:
- Clips, reports and incidents as different units
...
next_link:
  ...
  heading_title: Do More Witnesses Mean More UFOs?
header:
  og_image: /assets/images/ufo_report_databases_8352a3_duplicate_sighting_c_7649fb_ufo_video_report_cou_4c193a-Illustration-1-social.jpg
  preview_image: /assets/images/ufo_report_databases_8352a3_duplicate_sighting_c_7649fb_ufo_video_report_cou_4c193a-Illustration-1.webp
image: /assets/images/ufo_report_databases_8352a3_duplicate_sighting_c_7649fb_ufo_video_report_cou_4c193a-Illustration-1-social.jpg
---
...
NUFORC explicitly notes that some reports are judged explainable by human-made or natural phenomena while remaining part of the database. The archive functions as a record of reporting activity, not merely a collection of unexplained cases. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://nuforc.org/ndx/?id=loc" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nuforc.org">[NUFORC]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nuforc.org</span><span class="citation-popover-title">NUFOR C Reports by Location NUFORC Reports by Location; USA</span><span class="citation-popover-snippet">NUFORC Reports by LocationNUFORC Reports by Location; USA - Arizona, 5340; USA - California, 17150; USA - Colorado, 3574; USA - Conne...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why One UFO Clip Is Not Always One Event. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides investigation principles for separating observations, reports, evidence, and explanations.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Fits readers interested in UFO evidence, reports, and official handling, including modern media-linked cases.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for judging video repositories, repeated uploads, and misleading incident counts.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Supports the page’s central point that counts of clips, reports, and events can diverge.</p>
        <div class="fr-book-actions">

...
- ufo_report_databases_8352a3_national_archives_ua_19d014_uap_media_archiving_e9ae6e
...
show_ads: true
description: This page details how NARA's catalogue and bulk-download systems provide searchable access to UAP images, videos, and documents with metadata.
hero_summary: This page details how NARA's catalogue and bulk-download systems provide searchable access to UAP images, videos, and documents with metadata.
layout: default
...
page_heading_title: Using NARA Catalogues and Bulk Downloads for UAP Records
source_count: 36
infographic_count: 3
planned_sections:
- Catalogue entries and metadata fields
- Bulk download process and zip file structure
- Limitations and public accessibility notes
...
- basename: ufo_report_databases_8352a3_national_archives_ua_19d014_uap_media_archiving_e9ae6e
  title: Media Handling | Archives
  permalink: /media-handling/
  short_title: Media Handling
...
next_link:
  ...
  heading_title: Preserving UAP Photographs, Film, and Sound in Archives
header:
  og_image: /assets/images/ufo_report_databases_8352a3_national_archives_ua_19d014_uap_catalogue_bulk_d_f3c3e1-Illustration-1-social.jpg
  preview_image: /assets/images/ufo_report_databases_8352a3_national_archives_ua_19d014_uap_catalogue_bulk_d_f3c3e1-Illustration-1.webp
image: /assets/images/ufo_report_databases_8352a3_national_archives_ua_19d014_uap_catalogue_bulk_d_f3c3e1-Illustration-1-social.jpg
---
...
## Bulk download process and file structure

Beyond browsing individual catalogue entries, NARA provides a **bulk download system** for UAP‑related records. This is designed to let researchers download entire thematic sets of records—including photographs, videos, textual [case files]({{ 'case-files/' | relative_url }}), and audiovisual media—in a single step. On the National Archives bulk‑downloads page, each listing ties a catalogue series to two downloadable components: a **metadata JSON export** and a **full zip archive** of associated digital objects.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.nationalarchives.gov.uk/help-with-your-research/discovery-help/searching-for-records-using-discovery/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nationalarchives.gov.uk">[National Archives]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nationalarchives.gov.uk</span><span class="citation-popover-snippet">Searching for records using DiscoveryThere are two ways to look for a record using Discovery, searching or browsing. This section contain...</span></span></span>

### What’s included in the zip bundles

‑ **Metadata JSON**: Each export file (named with a `catalog-export‑<NAID>.json` pattern) contains structured metadata for records in that series, enabling programmatic access to fields such as titles, dates, media types, and digital object links.
...
Although catalogue and bulk download systems greatly facilitate access, there are important boundaries to be aware of:

‑ **Not everything is online or downloadable.** Some records have descriptive catalogue entries but no digital object available due to restrictions such as copyright or classification. In such cases, the bulk download won’t include a zip file; instead, the catalogue entry will point researchers to onsite access options at NARA.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.nationalarchives.gov.uk/help-with-your-research/discovery-help/searching-for-records-using-discovery/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nationalarchives.gov.uk">[National Archives]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nationalarchives.gov.uk</span><span class="citation-popover-snippet">Searching for records using DiscoveryThere are two ways to look for a record using Discovery, searching or browsing. This section contain...</span></span></span>

‑ **Redacted records.** Agencies transferring redacted and unredacted versions of UAP records may have only the redacted version available online. Metadata may note the presence of restrictions, but the full content may not be public.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.nationalarchives.gov.uk/help-with-your-research/discovery-help/searching-for-records-using-discovery/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nationalarchives.gov.uk">[National Archives]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nationalarchives.gov.uk</span><span class="citation-popover-snippet">Searching for records using DiscoveryThere are two ways to look for a record using Discovery, searching or browsing. This section contain...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Using NARA Catalogues and Bulk Downloads for UAP Records. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Appeals to readers using catalogues to investigate official UAP records and government disclosure claims.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps readers understand historical classification and case analysis behind many archived UFO materials.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains archival description, access, provenance, and records management concepts behind catalogue and bulk-download workflows.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Supports the page&#x27;s focus on metadata, cataloguing, archival hierarchy, and public access.</p>
        <div class="fr-book-actions">
...
<section class="further-reading-section" data-page-toc-exclude data-ebay-market-switch aria-labelledby="merchant-block-title">
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Browse similar items on eBay for It Came from Outer Space Retro Sci-Fi Alien Patch - Iron-On Applique, UFO Saucer"><img src="{{ '/assets/images/marketplace-covers/41621e8cd4f811e7f4f2.jpg' | relative_url }}" alt="Listing image for It Came from Outer Space Retro Sci-Fi Alien Patch - Iron-On Applique, UFO Saucer" loading="lazy" decoding="async" fetchpriority="low"></a>
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">It Came from Outer Space Retro Sci-Fi Alien Patch - Iron-On Applique, UFO Saucer</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.com</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">UFO Flying Saucer Patch Area 51 Alien Sublimated Sci-Fi Iron-on Badge Applique</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.com</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">UFO SPACESHIP GREEN ALIEN - UFO - EMBROIDERED Iron-on PATCH</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.com</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">GREEN SPACE ALIEN HEAD PATCH iron-on embroidered EXTRATERRESTRIAL AREA 51 UFO</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.com</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
      ...
      <div class="fr-section-footer">
        <a class="fr-browse-more" href="https://www.ebay.com/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Browse similar items on eBay for Flying Saucer Embroidered Patch Iron Sew On Clothing Alien NASA Space UFO Badge"><img src="{{ '/assets/images/marketplace-covers/6b15c2830d86d971cff6.jpg' | relative_url }}" alt="Listing image for Flying Saucer Embroidered Patch Iron Sew On Clothing Alien NASA Space UFO Badge" loading="lazy" decoding="async" fetchpriority="low"></a>
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">Flying Saucer Embroidered Patch Iron Sew On Clothing Alien NASA Space UFO Badge</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.co.uk</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">UFO SHADO - 2 Patch Set #1 - Gerry Anderson Ed Straker ITC - FREE P&amp;P - UK</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.co.uk</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">UFO Alien White Head Face Embroidered Iron Sew On Patch</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.co.uk</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        <p class="fr-book-kicker">Example eBay listing</p>
        <h4 class="fr-book-title">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">U/ROCK BAND SPACE SHIP IRON OR SEW ON QUALITY EMBROIDERED PATCH UK SELLER/UFO</a>
        </h4>
        <a class="fr-book-fit" href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer" aria-label="Search eBay for ufo patch">Search <span data-ebay-domain-label>eBay.co.uk</span>: ufo patch</a>
        <div class="fr-book-actions">
          <a href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
      ...
      <div class="fr-section-footer">
        <a class="fr-browse-more" href="https://www.ebay.co.uk/sch/i.html?_nkw=ufo+patch&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=catalogue-downloads-using-nara-catalogues-and-bulk-downloads-for-uap-records-ufo-report-database-ufo-patch&amp;toolid=10001" target="_blank" rel="sponsored noopener noreferrer">
